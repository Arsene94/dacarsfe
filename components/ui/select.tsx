    ...
    (
        ...
        return (
            <select
                ref={ref}
                className={cn(
                    "w-full appearance-none pl-4 pr-10 py-3 text-[#191919] border border-gray-300 rounded-lg focus:ring-2 focus:ring-jade focus:border-transparent font-sans disabled:cursor-not-allowed disabled:opacity-50",
                    className,
                )}
                style={{
