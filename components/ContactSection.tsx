...
const contactItems = [
  {
    ...
    content: (
      <a
        ...
        className="text-jade font-sans font-semibold hover:text-jade/80 transition-colors duration-300"
  ...
  },
  {
    ...
    content: (
      <p className="text-berkeley font-sans font-semibold">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <ul className="space-y-8">
            {contactItems.map(({ icon: Icon, title, description, content }) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-sans font-semibold text-berkeley mb-2">{title}</h3>
                  <p className="text-gray-600 font-sans mb-3">{description}</p>
                  {content}
                </div>
              </li>
            ))}
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <h3 className="text-2xl font-sans font-semibold text-berkeley mb-6">Locația noastră</h3>
            <LazyMap />

            <div className="mt-6 p-4 bg-jade/5 rounded-xl">
              <p className="text-berkeley font-sans">
