...
| `BLOG_API_TOKEN` | Token Sanctum cu permisiuni `blog_*` folosit de componentele server pentru a citi articolele protejate (în dezvoltare se acceptă și `NEXT_PUBLIC_BLOG_API_TOKEN`, însă recomandăm păstrarea token-ului pe server). | – |
