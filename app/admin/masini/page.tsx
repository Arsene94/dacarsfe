...
const CarsPage = () => {
  ...
  const isServiceDue = (nextServiceDate: string) => {
    ...
    const daysUntilService = Math.ceil((nextService.getTime() - today.getTime()) / (1000 * 3600 * 24));
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-poppins font-semibold text-berkeley">Gestionare Flota Auto</h1>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-dm-sans text-gray-600">Total Mașini</p>
                <p className="text-2xl font-poppins font-bold text-berkeley">{cars.length}</p>
              </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-dm-sans text-gray-600">Disponibile</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCars.map(car => (
            <div key={car.id} className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
              <div className="relative">
                <img 
                  src={car.image}
                  alt={car.name}
                ...
                <div className={`absolute top-4 right-4 px-3 py-1 rounded-full text-sm font-dm-sans font-semibold ${getStatusColor(car.status)}`}>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-xl font-poppins font-semibold text-berkeley">{car.name}</h3>
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    <p className="text-sm text-gray-600 font-dm-sans">Anul {car.year}</p>
                    <p className="text-sm text-gray-600 font-dm-sans">{car.mileage.toLocaleString()} km</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`px-3 py-1 rounded-full text-sm font-dm-sans ${getStatusColor(selectedCar.status)}`}>
                        {getStatusText(selectedCar.status)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="font-dm-sans text-gray-600">Număr înmatriculare:</span>
                      <span className="font-dm-sans font-semibold text-berkeley">{selectedCar.licensePlate}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="font-dm-sans text-gray-600">An fabricație:</span>
                      <span className="font-dm-sans font-semibold text-berkeley">{selectedCar.year}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="font-dm-sans text-gray-600">Kilometraj:</span>
                      <span className="font-dm-sans font-semibold text-berkeley">{selectedCar.mileage.toLocaleString()} km</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="font-dm-sans text-gray-600">Preț/zi:</span>
                      <span className="font-dm-sans font-bold text-jade text-lg">{selectedCar.price}€</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="font-poppins font-semibold text-berkeley text-lg mb-3">Specificații</h4>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-center space-x-2">
                        <Users className="h-4 w-4 text-jade" />
                        <span className="font-dm-sans text-gray-600">{selectedCar.features.passengers} persoane</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Settings className="h-4 w-4 text-jade" />
                        <span className="font-dm-sans text-gray-600">{selectedCar.features.transmission}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Fuel className="h-4 w-4 text-jade" />
                        <span className="font-dm-sans text-gray-600">{selectedCar.features.fuel}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Car className="h-4 w-4 text-jade" />
                        <span className="font-dm-sans text-gray-600">{selectedCar.features.doors} uși</span>
                      </div>
                    </div>
                  </div>

                  <div>
                    <h4 className="font-poppins font-semibold text-berkeley text-lg mb-3">Dotări</h4>
                    <div className="flex flex-wrap gap-2">
                      {selectedCar.specs.map((spec, index) => (
                        <span key={index} className="px-3 py-1 bg-jade/10 text-jade text-sm font-dm-sans rounded-full">
                          {spec}
                        </span>
                      ))}
                    </div>
                  ...
                  <div>
                    <h4 className="font-poppins font-semibold text-berkeley text-lg mb-3">Service</h4>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="font-dm-sans text-gray-600">Ultimul service:</span>
                        <span className="font-dm-sans text-gray-900">
                          {new Date(selectedCar.lastService).toLocaleDateString('ro-RO')}
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="font-dm-sans text-gray-600">Următorul service:</span>
                        <span className={`font-dm-sans ${isServiceDue(selectedCar.nextService) ? 'text-red-600 font-semibold' : 'text-gray-900'}`}>
                          {new Date(selectedCar.nextService).toLocaleDateString('ro-RO')}
                  ...
                  <div>
                    <h4 className="font-poppins font-semibold text-berkeley text-lg mb-3">Descriere</h4>
