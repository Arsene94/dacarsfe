        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-poppins font-semibold text-berkeley">Gestionare Rezervări</h1>
            </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  <th className="text-left py-4 px-6 font-dm-sans font-semibold text-gray-600">Rezervare</th>
                  <th className="text-left py-4 px-6 font-dm-sans font-semibold text-gray-600">Client</th>
                  <th className="text-left py-4 px-6 font-dm-sans font-semibold text-gray-600">Mașină</th>
                  <th className="text-left py-4 px-6 font-dm-sans font-semibold text-gray-600">Perioada</th>
                  <th className="text-left py-4 px-6 font-dm-sans font-semibold text-gray-600">Status</th>
                  <th className="text-left py-4 px-6 font-dm-sans font-semibold text-gray-600">Total</th>
                  <th className="text-left py-4 px-6 font-dm-sans font-semibold text-gray-600">Acțiuni</th>
                </tr>
              </thead>
              <tbody>
                {filteredReservations.map(reservation => (
                  <tr key={reservation.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6">
                      <div>
                        <div className="font-dm-sans font-semibold text-berkeley">{reservation.id}</div>
                    ...
                    <td className="py-4 px-6">
                      <div>
                        <div className="font-dm-sans font-semibold text-gray-900">{reservation.customerName}</div>
                        <div className="text-sm text-gray-500 font-dm-sans">{reservation.phone}</div>
                      </div>
                    </td>
                    <td className="py-4 px-6">
                      <div className="font-dm-sans text-gray-900">{reservation.carName}</div>
                    </td>
                    <td className="py-4 px-6">
                      <div>
                    ...
                    <td className="py-4 px-6">
                      <span className={`px-3 py-1 rounded-full text-sm font-dm-sans ${getStatusColor(reservation.status)}`}>
                        {getStatusText(reservation.status)}
                      </span>
                    </td>
                    <td className="py-4 px-6">
                      <div className="font-dm-sans font-semibold text-berkeley">{reservation.total}€</div>
                      {reservation.discountCode && (
                        <div className="text-sm text-jade font-dm-sans">Cod: {reservation.discountCode}</div>
                      )}
                    </td>
                    <td className="py-4 px-6">
            ...
            <div className="bg-white rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h4 className="font-poppins font-semibold text-berkeley text-lg">Informații Client</h4>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-dm-sans font-semibold text-gray-900">{selectedReservation.customerName}</p>
                        <p className="text-sm text-gray-600 font-dm-sans">{selectedReservation.phone}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-600 font-dm-sans">Email</p>
                        <p className="font-dm-sans text-gray-900">{selectedReservation.email}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* Reservation Info */}
                <div className="space-y-4">
                  <h4 className="font-poppins font-semibold text-berkeley text-lg">Detalii Rezervare</h4>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-600 font-dm-sans">Mașină</p>
                        <p className="font-dm-sans font-semibold text-gray-900">{selectedReservation.carName}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-600 font-dm-sans">Perioada</p>
                        <p className="font-dm-sans text-gray-900">
                          {new Date(selectedReservation.startDate).toLocaleDateString('ro-RO')} - {new Date(selectedReservation.endDate).toLocaleDateString('ro-RO')}
                        </p>
                        <p className="text-sm text-gray-600 font-dm-sans">
                          {selectedReservation.pickupTime} - {selectedReservation.dropoffTime}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-600 font-dm-sans">Locație</p>
                        <p className="font-dm-sans text-gray-900">{selectedReservation.location}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-poppins font-semibold text-berkeley mb-3">Status & Plată</h4>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="font-dm-sans text-gray-600">Status:</span>
                        <span className={`px-3 py-1 rounded-full text-sm font-dm-sans ${getStatusColor(selectedReservation.status)}`}>
                          {getStatusText(selectedReservation.status)}
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="font-dm-sans text-gray-600">Total:</span>
                        <span className="font-dm-sans font-bold text-berkeley text-lg">{selectedReservation.total}€</span>
                      </div>
                      {selectedReservation.discountCode && (
                        <div className="flex items-center justify-between">
                          <span className="font-dm-sans text-gray-600">Cod reducere:</span>
                          <span className="font-dm-sans text-jade font-semibold">{selectedReservation.discountCode}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  {selectedReservation.notes && (
                    <div>
                      <h4 className="font-poppins font-semibold text-berkeley mb-3">Notițe</h4>
